package com.example.mustafacan.mustafacanyilmazbitirmeprojesi.BenRobotDegilim;
...
/**
 * Created by Can on 14.5.2017.
 */

public class OperationCaptcha extends  MainCaptcha {
    ...
    public OperationCaptcha(int width, int height, MathOptions opt){
        this.height = height;
        setWidth(width);
        this.options = opt;
